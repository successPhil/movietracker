...
export MOVIE_API_KEY=$7
export UPCOMING_MOVIE_API_KEY=$8
...
sleep 10 
docker exec movietracker-api-1 python /src/manage.py makemigrations 
docker exec movietracker-api-1 python /src/manage.py migrate