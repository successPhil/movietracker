    ...
    return (
      ...
      <Box className="movie-container">
       <TextField
        ...
        <Container >
          {movies ? (<h1></h1>) : (<Typography variant="h1" ml={20} mt={4}style={{ fontFamily: 'Impact', fontSize: '5rem', color: '#ffc107', marginRight: 'auto', marginLeft: '275px' }}>Soon to be released!</Typography> )}
          <Grid container mt={3}>
            {movies ? (
